"""
Anthropic Status Service implementation
"""
...
class AnthropicStatusService(BaseStatusService):
    """Anthropic status monitoring service"""
    ...
    def _map_status_indicator(self, indicator: str) -> StatusType:
        """Map Anthropic status indicators to our StatusType enum"""
        mapping = {
    ...
    def _parse_datetime(self, date_str: str | None) -> datetime | None:
        """Parse datetime string from Anthropic API"""
        if not date_str:
            return None
        try:
